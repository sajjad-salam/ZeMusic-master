...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/G_D_U_VIP) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/G_D_U_VIP) \n ※[These Features AI Based](https://t.me/G_D_U_VIP)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
